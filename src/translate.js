...
chrome.runtime.onMessage.addListener( function (request, sender, sendResponse) {
	...
	switch(request.message) {
		//if you click the popup menu's GLISH plate, it reruns the page.
		case "hardrun":
			grab_and_go();
			break;
...
/*
	if (i === 0 && t.dataset.eng === "n") {
		...
		const shownword = t.dataset.cpt ? t.firstChild.textContent : t.firstChild.textContent.toLowerCase();
